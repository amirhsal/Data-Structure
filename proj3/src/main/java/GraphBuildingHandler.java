...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private GraphDB.Node lastNodeId;
    private ArrayList<Long> thisWay;
...
//            System.out.println("Id of a node in this way: " + attributes.getValue("ref"));
            ...
            long ids = Long.parseLong(attributes.getValue("ref"));
//            System.out.println(ids);
            thisWay.add(ids);
            long lastWayId = thisWay.get(thisWay.lastIndexOf(ids));
            System.out.println("last id: " + lastWayId);
...
//            System.out.println("Tag with k=" + k + ", v=" + v + ".");
            ...
            String locName = g.cleanString(attributes.getValue("v"));
            lastNodeId.putLocInTrie(locName);
//            System.out.println(g.cleanString(locName));
